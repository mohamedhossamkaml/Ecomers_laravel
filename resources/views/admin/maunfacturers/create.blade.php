@extends('admin.index')
@section('head')
    <li class="{{active_menu_s('create')[0]}} btn btn-info"><a href="{{ aurl('maunfacturers') }}" ><i class="fas fa-industry"></i> {{ atrans('maunfacturers') }} </a></li>
@endsection
@section('content')
...
<div class="box">
    ...
    <div class="box-body">
        ...
        {!! Form::open(['url'=>aurl('maunfacturers') ,'files'=>true ]) !!}
