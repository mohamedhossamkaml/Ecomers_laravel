...
<!-- Font Awesome -->
<script  src="{{url('')}}/design/AdminLTE/bower_components/font-awesome/js/fontawesome.min.js"></script>
<script  src="{{url('')}}/design/AdminLTE/bower_components/font-awesome/js/all.min.js"></script>
<script  src="{{url('')}}/design/AdminLTE/bower_components/font-awesome/js/brands.min.js"></script>
<script  src="{{url('')}}/design/AdminLTE/bower_components/font-awesome/js/solid.min.js"></script>
<!-- Morris.js charts -->
...
<script src="{{url('')}}/design/adminlt/dist/js/myfunction.js"></script>

<script src="{{url('')}}/design/adminlt/jstree/jstree.js"></script>
<script src="{{url('')}}/design/adminlt/jstree/jstree.wholerow.js"></script>
<script src="{{url('')}}/design/adminlt/jstree/jstree.checkbox.js"></script>
...
@else
<!-- AdminLTE App -->
<script src="{{url('')}}/design/AdminLTE/dist/js/js/app.min.js"></script>
<script src="{{url('')}}/design/AdminLTE/dist/js/js/pages/dashboard.js"></script>
<script src="{{url('')}}/design/AdminLTE/dist/js/js/demo.js"></script>
