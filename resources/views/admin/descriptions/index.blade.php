        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>
                        {{ atrans('ask_delete_dep') }} <span id="dep_name"></span>
                    </p>
                </div>
...
<div class="box">
    ...
    <div class="box-body ">
        ...
        <a href="" class="btn btn-info edit_dep showbtn_control hidden"><i class="fa fa-edit"></i> {{ atrans('edit') }}</a>
        <a href="" class="btn btn-danger delete_dep showbtn_control hidden" data-toggle="modal" data-target="#delete_bootstrap_modal"><i class="fa fa-trash"></i> {{ atrans('delete') }}</a>
