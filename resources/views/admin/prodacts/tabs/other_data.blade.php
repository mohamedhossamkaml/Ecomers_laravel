    ...
    <script>
        ...
        $(document).on('click','.add_input',function()
        {
            ...
            if (x < max_input) {
                ...
                '<div>'+
                    '<div class="col-md-6">'+
                        ' {!! Form::label('input_key',atrans('input_key')) !!}'+
                        '{!! Form::text('input_key[]','',['class'=>'form-control']) !!}'+
                    '</div>'+
                    '<div class="col-md-6">'+
                        '{!! Form::label('input_value',atrans('input_value')) !!}'+
...
<div id="other_data" class="tab-pane fade">
    <h3>{{ atrans('other_data') }}</h3>
    
    <div class="div_inputs col-lg-12 col-md-12 col-ms-12">
