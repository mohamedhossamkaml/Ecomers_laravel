...
<button type="button" class="btn btn-info" data-toggle="modal" data-target="#del_admins{{$id}}"><i class="fas fa-trash-restore"></i></button>
...
<div id="del_admins{{$id}}" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            {!! Form::open(['url'=>aurl('prodacts/restor/deleted/'.$id)]) !!}
            <div class="modal-body">
                <p>{{ trans('admin.restore_this',['name'=>$title])  }}</p>
            </div>
