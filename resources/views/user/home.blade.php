        ...
        {{-- <div class="row">
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-olive ">
                    ...
                    <a href="{{ aurl('users') }}" class="small-box-footer">{{ atrans('more_info') }} <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-purple-gradient  ">
                    ...
                    <a href="{{ aurl('molls') }}" class="small-box-footer">{{ atrans('more_info') }}  <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-black-gradient ">
                    ...
                    <a href="{{ aurl('maunfacturers') }}" class="small-box-footer">{{ atrans('more_info') }}  <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-xs-6">
