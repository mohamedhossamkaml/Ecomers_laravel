...
class ProdactsDatatable  extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ->addColumn('checkbox', 'admin.prodacts.btn.checkbox')
            ->addColumn('edit', 'admin.prodacts.btn.edit')
            ->addColumn('soft', 'admin.prodacts.btn.soft')
            ->addColumn('delete', 'admin.prodacts.btn.delete')
            ->rawColumns(
                [
                    'edit',
                    'soft',
