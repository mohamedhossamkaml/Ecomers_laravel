...
class MaunfactsDatatable  extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ->addColumn('checkbox', 'admin.maunfacturers.btn.checkbox')
            ->addColumn('edit', 'admin.maunfacturers.btn.edit')
            ->addColumn('delete', 'admin.maunfacturers.btn.delete')
            ->rawColumns(
                [
                    'edit',
                    'delete',
    ...
    {
        return 'maunfacturers_' . date('YmdHis');
    }
}
